...
/**
 *  蓝色视图，红色视图上方50，与红色右边缘对齐，宽高等于紫色视图高宽
 */
...
- (void)viewDidLoad {
    ...
    /**
     *  使用Masonry添加约束的方式有3种：makeContraint：多次调用，是累加的效果
     remakeContraint:删除之前约束，添加新的约束
...
#warning 如果是AutoLayout模式，做移动位置或者大小的动画，一定要通知视图，实时根据新的约束刷新位置和大小
//        [self.view layoutIfNeeded];
        /**
         *  只想更新紫色的，需要先标记要更新的视图
