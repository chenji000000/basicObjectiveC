...
{
    //将服务器返回的result（字典）转化成由TRDeal组成的数组
    ...
    for (TRDeal *deal in dealsArray) {
        ...
        NSArray *businessArray=[TRMetaDataTool parseResultFromServer:deal.businesses withClass:[TRBusiness class]];
        ...
        for (TRBusiness *business in businessArray) {
            ...
            //没有找到分类对象
                annotation.image=[UIImage imageNamed:@"ic_category_default.png"];
            }
